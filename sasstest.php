...
<script src="assets/jquery/sassquiz.js"></script>
</head>
<body>
<?php  include('assets/inc/header.php')?>
  ...
  <div id="result"></div>
  <div id="continue"></div>
  <div id="redo"><a href="sasstest.php" class="btn btn-primary btn-lg">Retry the test</a></div>
  <div id="finished"><a href="Leren.php" class="btn btn-primary btn-lg">Return</a>
<br>
<br>
<a href="https://www.sololearn.com/Course/CSS/" class="btn btn-primary btn-lg">Learn more on Sololearn</a>
  </div>
</div>
